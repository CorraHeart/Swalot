...
set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.95);
...
set_window_value(AT_DATTACK, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.4);
...
set_hitbox_value(AT_DATTACK, 2, HG_LIFETIME, 17);
