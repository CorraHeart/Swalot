...
set_window_value(AT_FAIR, 4, AG_WINDOW_VSPEED, .7);
...
set_window_value(AT_FAIR, 8, AG_WINDOW_CANCEL_FRAME, 2);
set_window_value(AT_FAIR, 8, AG_WINDOW_CUSTOM_GRAVITY, .45);
