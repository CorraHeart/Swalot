...
sprite_change_offset("jab", 96, 192);
sprite_change_offset("dattack", 96, 192);
sprite_change_offset("ftilt", 32, 62);
sprite_change_offset("dtilt", 96, 192);
sprite_change_offset("utilt", 64, 94);
sprite_change_offset("nair", 64, 94);
sprite_change_offset("fair", 96, 192);
...
sprite_change_offset("ustrong", 96, 192);
